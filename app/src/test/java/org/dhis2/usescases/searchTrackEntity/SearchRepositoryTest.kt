...
class SearchRepositoryTest {
    ...
    @Test
    fun `isSearchEnabled delegates to RAMP datastore repository`() {
        val programUid = "programUid"
        searchRepositoryJava.setCurrentProgram(programUid)
        whenever(rampDatastoreRepository.isSearchEnabled(programUid)) doReturn false

        assertTrue(!searchRepositoryJava.isSearchEnabled)
    }
