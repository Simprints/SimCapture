...
class TeiDashboardMobileActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        syncDetailsNavigationItemVisibility()
    ...
    private fun syncDetailsNavigationItemVisibility() {
        val portrait = isPortrait()
        dashboardViewModel.setDetailsNavigationItemVisible(
            visible = portrait,
            forceDisplayForSimprintsRampTable =
                !portrait && isSimprintsRampHistoryTableLandscapeFullscreen,
        )
    }
