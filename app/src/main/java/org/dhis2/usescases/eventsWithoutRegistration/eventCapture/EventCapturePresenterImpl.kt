...
class EventCapturePresenterImpl(
    ...
    private var forceDisplayDataEntryNavigationItemForSimprintsRampTable = false
    ...
    override fun setForceDisplayDataEntryNavigationItemForSimprintsRampTable(forceDisplay: Boolean) {
        if (forceDisplayDataEntryNavigationItemForSimprintsRampTable != forceDisplay) {
            forceDisplayDataEntryNavigationItemForSimprintsRampTable = forceDisplay
            loadBottomBarItems()
        }
    }
