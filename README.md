...
| Infra: signed APK releases              | [app/build.gradle.kts#L85](app/build.gradle.kts)                                                       | Code change    | App's Package ID set to `com.simprints.simcapture`                                            |
| Docs: fork-specific README              | [README.md#L1-L20](README.md)                                                                          | Code change    | This section in README                                                                        |
